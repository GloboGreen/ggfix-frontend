  ...
  if (!shopId) {
    return (
      <SafeAreaView style={styles.safe} edges={['top']}>
        <View style={styles.center}><Text style={styles.error}>Please log in again.</Text></View>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      >
        ...
        {loading ? (
          ...
          <TouchableOpacity style={styles.uploadBtn} onPress={() => navigation.navigate('OwnerKycUpload')} activeOpacity={0.85}>
          ...
          <>
            <View style={styles.actionRow}>
              ...
              <TouchableOpacity style={styles.editBtn} onPress={onEdit} activeOpacity={0.85}>
                <Ionicons name="create-outline" size={13} color="#3B4FD7" />
...
const styles = StyleSheet.create({
  ...
  statusPending:  { backgroundColor: '#3B4FD7' },
  ...
  editBtnText: { fontSize: 11, color: '#3B4FD7', fontWeight: '700' },
