...
export default function TechnicianApplyLeaveScreen({ navigation }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Leave request sent to owner',
        'Your leave request has been submitted. The owner will review and approve or deny it.',
        [{ text: 'OK', onPress: () => navigation.navigate('TechnicianProfile') }]
      );
    } catch (e) {
